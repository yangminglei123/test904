...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
		    //准备当前阶段
			Tran t = (Tran) request.getAttribute("t");//拿到上下文中的tran对象
			String currentStage = t.getStage();//取出当前阶段stage  03价值建议
			//准备当前阶段的可能性
			String currentPossibility = pMap.get(currentStage);//通过key返回value。传入stage返回可能性 40
	...
	<div style="position: relative; top: 0px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${t.description}</b></div>
