...
request.getContextPath() + "/";
	...
	Map<String,String> pMap = (Map<String,String>)application.getAttribute("pMap");//在作用域中取出监听器中放入的map
	...
	<form action="transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="d3b76e9b936f46538227a80f10d9c6d4">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="67914d94599c459f88b2ac90086896c6" name="contactsId">
			</div>
		</div>
